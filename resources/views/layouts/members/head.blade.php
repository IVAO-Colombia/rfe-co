...
/>
<link
    href="{{ URL::asset('/src/css/custom.css') }}"
    rel="stylesheet"
    type="text/css"
/>
...
<!-- Icons -->
<script
    src="https://kit.fontawesome.com/8549e59a3d.js"
    crossorigin="anonymous"
></script>
...
<link
    rel="icon"
    type="image/svg+xml"
    href="{{ URL::asset('/src/img/ivao-co.svg') }}"
/>
<meta name="description" content="" />
<meta name="author" content="Jose Cuervo & Martin Sierra" />
