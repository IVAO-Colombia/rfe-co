<nav class="navbar navbar-expand-lg navbar-light bg-dark-blue">
    <div class="container">
        <a class="navbar-brand" href="{{ route('Home') }}"
            ><img class="logo" src="{{ URL::asset('/src/img/ivao-co.svg') }}"
        /></a>
        <button
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarLangDrop">
                        <li>
                            <a class="dropdown-item" href="{{ route('PilotsBriefing') }}"
                                ><i class="fas fa-user-tie fa-fw"></i>&nbsp;{{
                                    __("custom.PilotsBriefing")
                                }}</a
                            >
                        </li>
                    </ul>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarLangDrop">
                        ...
                        <li>
                            <a
                                class="dropdown-item"
                                href="{{ route('AtcBooking') }}"
                                ><i class="fas fa-broadcast-tower fa-fw"></i
                                >&nbsp;{{ __("custom.AtcBooking") }}</a
                            >
                        </li>
                    </ul>
                </li>
