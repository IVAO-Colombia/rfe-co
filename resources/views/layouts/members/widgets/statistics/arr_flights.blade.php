@php
    $arr_flights= DB::select('SELECT COUNT(`flight`) FROM `bookings` WHERE `type` = "arrival"');
    foreach ($arr_flights as $flights_arr) {
    }
    $total_flights_arr = $flights_arr->{'COUNT(`flight`)'};
    $bookings=DB::select('SELECT COUNT(`user_id`) FROM `bookings` WHERE `type` = "arrival"');
        ...
        <div class="col-md-10">
            ...
            <div class="progress" style="height: 2rem">
                ...
                <div
                    ...
                    role="progressbar"
                    aria-valuenow="{{ $total_flights_arr }}"
                    aria-valuemin="0"
                    aria-valuemax="100"
