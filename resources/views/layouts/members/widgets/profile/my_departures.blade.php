@php $myVID = Auth::id(); $myFlights =
App\Models\Flight::where('user_id',"$myVID")->get(); @endphp
<div class="accordion" id="accordionFlights">
    @foreach ($myFlights as $flight) @if ($flight->type=='departure')
    <div class="card">
        ...
        <div
            ...
            class="collapse"
            aria-labelledby="heading{{$flight->id}}"
        ...
        >
            <div class="card-body">
                    ...
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-md-4" style="text-align: center">
                            <h4>
                                ...
                                $splitTime[0].":".$splitTime[1]."&nbsp;Z"; echo
                                $zuluTime; @endphp
                            </h4>
                        </div>
                ...
                <form
                    action="{{ route('unbook.update', $flight->id) }}"
                    method="POST"
                >
                    @csrf @method('PUT')
