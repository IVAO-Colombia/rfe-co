<div class="container" style="height: 100vh">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card homeCard">
                <a href="<?php echo e(URL::asset('/src/doc/airport.pdf')); ?>" target="_blank"><img src="<?php echo e(URL::asset('/src/img/chart/airport.png')); ?>" class="card-img"
                        style="width:50%" /></a>
            </div>
            <div class="clearfix" style="height: 2rem"></div>
            <div class="card homeCard">
                <a href="<?php echo e(URL::asset('/src/doc/gates.pdf')); ?>" target="_blank"><img src="<?php echo e(URL::asset('/src/img/chart/gates.png')); ?>" class="card-img"
                        style="width: 80%
                /></a>
            </div>
            <div class="clearfix"
            ...
            <div class="card homeCard">
                <div class="card-body">
                    <a class="LinkSKBO" href="<?php echo e(URL::asset('/src/doc/SKBO.pdf')); ?>" target="_blank">
                        <h5 class="card-title">
            ...
            <div class="card homeCard">
                <div class="card-body">
                    <a class="LinkSKBO" href="<?php echo e(URL::asset('/src/doc/TMA.pdf')); ?>" target="_blank">
                        <h5 class="card-title">
