<div>
    ...
    <div class="grid auto-rows-auto">
        ...
        <div class="grid gap-2 lg:grid-cols-3 lg:grid-cols-2 mx-5 grid-cols-1">
            @foreach ($flights as $item)
            <div class="max-w-md w-full h-full mx-auto z-10 bg-ivao-blue rounded-3xl">
        ...
        <div
            ...
            <div
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 60" fill="currentColor"
                    class="mx-auto mt-8 h-16 w-16 text-ivao-blue">
                ...
                <div class="space-x-4 bg-gray-100 py-4 text-center">
                    <button wire:click='unbookAtc({{$item->id}})'
                        class="inline-block rounded-md bg-ivao-red px-10 py-2 font-semibold text-red-100 shadow-md duration-75 hover:bg-red-400">Unbook</button>
                </div>
            </div>
            @endforeach
        </div>
