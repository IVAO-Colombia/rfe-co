    ...
    <section class="container px-4 mx-auto">
        ...
        <div class="mt-6 md:flex md:items-center md:justify-between">
            ...
            <div class="relative flex items-center mt-4 md:mt-0">
                ...
                <input type="text" placeholder="Search by Flight" wire:model.live='search'
        ...
        @switch($this->type)
        @case("arr")
        @include('website.rfe23.widgets.booking.arr_flights')
        @break
        @case("dpt")
        @include('website.rfe23.widgets.booking.dpt_flights')
        @break
        @default
        @include('website.rfe23.widgets.booking.all_flights')
        @endswitch
    </section>
